...
from KAN_CNN import KAConv, SimpleModel, KANet5, SimpleCNN
from LeNET import LeNet5, SimpleLeNet
...
def main(cfg: DictConfig) -> None:
    ...
    if name == "KANet":
        ...
        model = SimpleCNN(in_c, out_c, ker_size).to(device)
    ...
    x_val = x_train[train_size: train_size + train_size // 5]
    y_val = y_train[train_size:train_size + train_size // 5]
